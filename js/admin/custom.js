$(document).ready(function() {
	...
	$(".expand_custom a").click(function(e){
		...
		el.find('.custom .expand_custom').html('<img src="/images/admin/preload.gif" alt="">');
		setTimeout(function() {
	...
	if($(this).parent().find('.collapsed-nav').is(":visible")){
		...
		$(this).find('img').attr("src", '/images/admin/toggle-subnav-down.png');
	} else {
		$(this).parent().addClass("active open");
		$(this).parent().find('.collapsed-nav').slideDown();
		$(this).find('img').attr("src", '/images/admin/toggle-subnav-up-white.png');
	}
	});
