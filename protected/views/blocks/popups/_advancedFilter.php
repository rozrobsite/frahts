<div id="advancedFilterDialog" class="dialog" title="Расширенный фильтр">
	<?php
	echo CHtml::beginForm(isset($vid) ? '/vehicle/search/vid/' . $vid : '',
	...
	<div class="widget fluid" style="margin-top: 0px;">
		...
		<div class="formRow">
			<div class="grid12">
				<label>Укажите текущее расположение вашего транспорта:</label>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
		...
		<div class="formRow">
			<div class="grid12">
				<label>Укажите желаемый пункт доставки груза:</label>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
