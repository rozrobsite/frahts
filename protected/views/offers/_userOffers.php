...
<?php else: ?>
	...
	<?php if($this->user->profiles->user_type_id == UserTypes::FREIGHTER): ?>
		Чтобы сделать предложение перейдите на страницу поиска подходящего Вам <a href="/goods/search">транспортного средства</a>. Зайдите на страницу подходящего Вам объявления 
		и нажмите кнопку "Предложить свой груз".
	<?php elseif($this->user->profiles->user_type_id == UserTypes::SHIPPER): ?>
		Чтобы сделать предложение перейдите на страницу поиска подходящего Вам <a href="/vehicle/search">груза</a>. Зайдите на страницу подходящего Вам объявления 
		и нажмите кнопку "Предложить свой транспорт".
	<?php else: ?>
		Чтобы сделать предложение перейдите на страницу поиска подходящего Вам <a href="/vehicle/search">груза</a> или <a href="/goods/search">транспортного средства</a>. Зайдите на страницу подходящего Вам объявления 
		и нажмите кнопку "Предложить свой груз" или "Предложить свой транспорт".
	<?php endif; ?>
<?php endif; ?>
