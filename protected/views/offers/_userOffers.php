				...
				<td class="tableActs">
					...
					<?php elseif ($offer->result == Offers::RESULT_IN_ACCEPT): ?>
						...
						<?php if (!$offer->review_id): ?>
							<a href="/user/view/<?php echo $offer->receivingUser->id; ?>/offer/<?php echo $offer->id ?>#tab_comments">Оставить отзыв</a>
						<?php endif; ?>
					<?php else: ?>
...
<?php else: ?>
	<strong>Вы еще не делали предложения пользователям.</strong><br/>
	<?php if($this->user == UserTypes::FREIGHTER): ?>
		Чтобы сделать предложение найдите на странице <a href="/goods/search">поиска</a> подходящее Вам транспортное средство. Зайдите на страницу этого транспортного средства и нажмите кнопку <strong>"Предложить свой груз"</strong>.
	<?php elseif($this->user == UserTypes::SHIPPER): ?>
		Чтобы сделать предложение найдите на странице <a href="/vehicle/search">поиска</a> подходящий Вам груз. Зайдите на страницу этого груза и нажмите кнопку <strong>"Предложить свой транспорт"</strong>.
	<?php else: ?>
		Чтобы сделать предложение найдите на странице <a href="/goods/search">поиска транспорта</a> подходящее Вам транспортное средство. Зайдите на страницу этого транспортного средства и нажмите кнопку <strong>"Предложить свой груз"</strong>.
		Или найдите на странице <a href="/vehicle/search">поиска груза</a> подходящий Вам груз. Зайдите на страницу этого груза и нажмите кнопку <strong>"Предложить свой транспорт"</strong>.
	<?php endif; ?>
<?php endif; ?>
