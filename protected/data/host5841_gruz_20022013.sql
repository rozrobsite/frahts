...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 20 2013 г., 22:44
...
INSERT INTO `city` (`id`, `country_id`, `region_id`, `name_ru`) VALUES
(6, 4, 5, 'Балларат'),
(7, 4, 5, 'Бендиго'),
(8, 4, 5, 'Варрнамбул'),
(9, 4, 5, 'Водонга'),
...
INSERT INTO `country` (`id`, `name_ru`) VALUES
(4, 'Австралия'),
(63, 'Австрия'),
(81, 'Азербайджан'),
(173, 'Ангуилья'),
...
INSERT INTO `goods` (`id`, `user_id`, `date_from`, `date_to`, `name`, `country_id_from`, `region_id_from`, `city_id_from`, `country_id_to`, `region_id_to`, `city_id_to`, `vehicle_types`, `body_types`, `shipments`, `weight_from`, `weight_to`, `capacity_from`, `capacity_to`, `permissions`, `cost`, `currency_id`, `payment_type_id`, `description`, `created_at`, `updated_at`, `is_deleted`) VALUES
(1, 28, 1359673200, 1362006000, 'Мороженное мясо из Брази', 63, 70, 71, 7716093, 7716133, 7716144, '9,11', '6,9,2', '1,2,3', 4.5, 8, 9, 15, '4,6', 1500, 1, 2, 'lhkj jnjnkj\r\n;kjklkl', 1360429626, 1361131052, 0),
(2, 28, 1360796400, 1361833200, 'Автошину новые', 971, 979, 980, 401, 402, 403, '9', '5', '1,14', 4.5, 7, 6, 12, '6,5', 1200, 3, 3, 'sdsfdsf fdsfdsf', 1360429999, 1361396432, 0),
(3, 28, 1361401200, 1362006000, 'dsfdsf dfdsfdsf sfdsfdsfd', 245, 277654, 278012, 7716093, 7716133, 7716144, '9', '9,11', '1,3', 3, 7.5, 4, 9, '1,3,5', 1222, 3, 4, 'Описание <>?//\\\\||!@#$%^&*()_+', 1360439626, 1361396485, 0),
(4, 28, 1360710000, 1361919600, 'khghj jhjgj', 177, 204, 205, 248, 304, 309, '9,10', '9,11,13,15', '2,12', 2, 5, 4, 9, '1,6,3', 1200, 3, 1, 'dfgdfgd', 1360429696, 1361130673, 0),
(5, 28, 1359673200, 1362006000, 'khghj jhjgj', 177, 204, 205, 245, 246, 247, '9,10', '9', '2,12', 2, 5, 4, 10, '1,6,3', 1200, 3, 1, 'dfgdfgd', 1360429986, 1361130685, 0),
(6, 28, 1360364400, 1362006000, 'khghj jhjgj', 177, 204, 205, 245, 246, 247, '9,10', '9', '2,12', 2, 4.5, 4, 10, '1,6,3', 1200, 3, 1, 'dfgdfgd', 1360429699, 1361130751, 0),
(7, 28, 1360623600, 1361401200, 'Автошины б/у', 81, 164, 165, 2514, 2515, 2525, '9,10', '8,11', '1,2', 3, 6, 9, 12, '1,3', 555, 4, 1, 'рпапр лоррор', 1361396568, NULL, 0);
...
CREATE TABLE IF NOT EXISTS `makes` (
  ...
  PRIMARY KEY (`id`),
  KEY `make_name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=793 ;
...
(39, 'Kia', 'Киа'),
(53, 'Mazda', 'Мазда'),
(54, 'Mercedes-Benz', 'Мерседес'),
(57, 'Mitsubishi', 'Митсубиси'),
(59, 'Nissan', 'Ниссан'),
(62, 'Opel', 'Опель'),
(63, 'Peugeot', 'Пежо'),
(64, 'Piaggio', ''),
...
(525, 'Orthaus', ''),
(526, 'Knapen', ''),
(527, 'Hoffmann', 'Hofman Hofmann Hoffman'),
(528, 'Kempf', ''),
(529, 'ATM', ''),
(530, 'Lenaerts', ''),
(531, 'Schmidt', ''),
...
CREATE TABLE IF NOT EXISTS `models` (
  ...
  KEY `model_name` (`name`),
  KEY `make_id` (`make_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=3556 ;
...
(397, 'Escort', '', 29),
(401, 'Express', '', 29),
(402, 'F 150', 'F-150 F150', 29),
(403, 'F 250', 'F-250 F250', 29),
(404, 'F 350', 'F-350  F350', 29),
(423, 'Ranger', '', 29),
(431, 'Tourneo', '', 29),
(432, 'Transit', '', 29),
(437, 'Sierra', '', 30),
...
(1195, 'Terra', '', 74),
(1227, 'Libero', '', 78),
(1265, 'Hiace', 'Hi-ace', 82),
(1266, 'Hilux', '', 82),
(1269, 'Lite-Ace', '', 82),
(1348, 'LT', '', 87),
(1357, 'Transporter (T1)', '', 87),
(1358, 'Transporter (T2)', '', 87),
(1360, 'Transporter (T3) Caravelle', '', 87),
(1361, 'Transporter (T3) Multivan', '', 87),
(1363, 'Transporter (T4) Caravelle', '', 87),
(1364, 'Transporter (T4) Multivan', '', 87),
(1369, 'Taro', 'Tarro', 87),
(1383, 'Lublin', '', 23),
(1384, 'Daily', '', 147),
(1385, 'Turbo Daily', '', 147),
(1389, 'Jumper', '', 19),
(1391, '1203', '', 75),
(1392, '135 Pick-Up', '', 75),
(1393, 'Fabia Praktik', '', 75),
(1394, 'Felicia Pick-Up', '', 75),
(1395, 'Praktik', '', 75),
(1396, '15', '', 144),
(1397, '21', '', 144),
(1398, '30', '', 144),
...
(1409, 'S 76', '', 24),
(1410, 'Sprinter', '', 26),
(1411, 'Doblo cargo', 'Dobló cargo', 28),
(1412, 'Scudato', '', 28),
(1413, 'Talento', '', 28),
(1414, 'E150', '', 29),
(1415, 'E250', '', 29),
...
(1418, 'F 450', 'F-450', 29),
(1419, 'Fiesta Van', '', 29),
(1420, 'Transit Connect', '', 29),
(1421, 'Tourneo Connect', '', 29),
(1422, 'C', '', 30),
(1423, 'K', '', 30),
(1424, 'Truck', '', 34),
(1425, 'Rival', '', 147),
...
(1973, 'CSD3\r\n', '', 721),
(1974, '1001 XL', '', 722),
(1975, '1003 XL Racer', '', 722),
(1976, '1003 XXL Pullman', '', 722),
(1977, '2000 L Racer', '', 722),
(1978, '2002 XL', '', 722),
(1979, '2003 Competitor', '', 722),
(1980, '2003 L Pullman', '', 722),
(1981, '2003 Pullman', '', 722),
(1982, '2003 Racer', '', 722),
(1983, '2003 XL', '', 722),
(1984, '2004 XL', '', 722),
(1985, '4002', '', 722),
(1986, 'Gold Classic', '', 722),
(1987, 'Gold Magnum', '', 722),
(1988, 'Living', '', 722),
(1989, 'Poney\r\n', '', 722),
(1990, '9963\r\n', '', 723),
(1991, 'S4L\r\n', '', 724),
...
(2074, 'П-5', '', 740),
(2075, 'ПП-10\r\n', '', 740),
(3454, 'CA_1031', 'CA 1031', 769),
(3455, 'BJ1041V9(J/P)E6-S', 'BJ1041V9(J/P)E6-S', 771),
(3456, 'BJ1069VС(J/P)EA-D', 'BJ1069VС(J/P)EA-D', 771),
(3457, 'BJ1089VD(P/F)G-SD', 'BJ1089VD(P/F)G-SD', 771),
(3458, 'BJ1093VE(P/E)D-S', 'BJ1093VE(P/E)D-S', 771),
(3462, '1020', '1020', 773),
(3463, 'LPT 613', 'LPT 613', 81),
(3464, 'DF-30', 'DF-30', 775),
(3465, 'MD 1044L', '', 776),
(3466, 'MD 1044L БТ', '', 776),
(3467, 'MD 1044Z', '', 776),
(3468, 'MD 1044БТ', '', 776),
(3469, 'MD 1044П', '', 776),
(3470, 'MD 1044И', '', 776),
...
(7, 28, 'Петренко', 'Петр', 'Петрович', '(234) 568-7452', 9908, 10455, 10457, 'пушкина 300', '1234567', 'aaaa1234', '657432890', 0, 2, 1360407557, NULL);
...
(27, 'imperia1991@gmail.com', 'imperia1991@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 39, 1361388635, '', 'n', 120),
(28, 'a@a.com', 'a@a.com', 'e10adc3949ba59abbe56e057f20f883e', 13, 1361389178, '', 'n', 120);
...
(1, 27, 39, 9, 543, 6, 9.5, 20, 'СА 2345 ВО', '', '', 0, 1, '4,2', NULL, 0, 1360429626, 1360429626),
