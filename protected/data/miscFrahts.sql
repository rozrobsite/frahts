...
ALTER TABLE `vehicle` ADD FOREIGN KEY ( `country_id_to` ) REFERENCES `host5841_frahts`.`country` (
`id`
) ON DELETE SET NULL ON UPDATE RESTRICT;

ALTER TABLE `vehicle` ADD FOREIGN KEY ( `region_id_to` ) REFERENCES `host5841_frahts`.`region` (
`id`
) ON DELETE SET NULL ON UPDATE RESTRICT;
ALTER TABLE `vehicle` ADD FOREIGN KEY ( `city_id_to` ) REFERENCES `host5841_frahts`.`city` (
`id`
) ON DELETE SET NULL ON UPDATE RESTRICT;