...
class VehicleTypes extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'bodyTypes' => array(self::HAS_MANY, 'BodyTypes', 'vehicle_type_id'),
			'vehicleFerrymans' => array(self::HAS_MANY, 'VehicleFerrymans', 'vehicle_type_id'),
		);
	}
