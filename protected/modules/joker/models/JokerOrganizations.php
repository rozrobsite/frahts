...
class JokerOrganizations extends ManyManyActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, user_id, name, description, country_id, region_id, city_id, address, mobile, phone, email, skype, site, discount, latitude, longitude, logo, enabled', 'safe', 'on' => 'search'),
