<?php
$this->pageTitle = Yii::app()->params['joker']['name'] . ' - Вход';
...
<div class="loginWrapper">
	...
	*/ ?>
	<div class="logControl">
		<a href="/joker/main/forgot" class="buttonM bLightBlue" style="margin-left: -52px;">Забыли пароль?</a>
